                    ...
                    <div className="form-group" style={{ padding: "20px" }}>
                        ...
                        {showInput ? (
                            <div className="d-flex mt-3">
                                ...
                                />
                                <button onClick={handleAddBenefit} className="btn btn-success" style={{height: '38px', marginTop: '7px'}}>+</button>
                            </div>
                        ) : (
                            <button onClick={() => setShowInput(true)} className="btn btn-primary mt-3">+</button>
                        )}
                    </div>
