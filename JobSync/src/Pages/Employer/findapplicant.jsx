...
export default function FindApplicant() {
  ...
  return (
    <div className="container-fluid d-flex flex-column min-vh-100" style={{ marginRight: "290px" }}>
      {/* Search Bar with Find Job Button */}
      <div style={{ backgroundColor: "#f1f2f4", width: "100%", margin: "0", padding: "0", position: 'absolute', left: '0', height: '180px' }}>
      ...
      <div className="d-flex flex-grow-1 ms-3" style={{marginTop: '260px'}}>
        {/* Sidebar */}
        <div className="sidebar border p-3" style={{ width: "350px", borderRadius: "10px", marginTop: '-35px', height: '356px', boxShadow: "rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px" }}>
          ...
          <div className="filter-group">
            ...
            <div className="form-check d-flex align-items-center mb-2">
              <input className="form-check-input" type="radio" name="gender" value="all" id="gender-all" defaultChecked />
              <label className="form-check-label ms-2" htmlFor="gender-all">All</label>
            </div>
            <div className="form-check d-flex align-items-center mb-2">
              <input className="form-check-input" type="radio" name="gender" value="male" id="gender-male" />
              <label className="form-check-label ms-2" htmlFor="gender-male">Male</label>
            </div>
            <div className="form-check d-flex align-items-center mb-2">
              <input className="form-check-input" type="radio" name="gender" value="female" id="gender-female" />
              <label className="form-check-label ms-2" htmlFor="gender-female">Female</label>
            </div>
          </div>
        </div>
